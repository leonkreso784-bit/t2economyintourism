# Bugovi — ARHIVA (riješeni do 2026-08-30)

> **Referenca, ne istina.** Ovdje su bugovi **BUG-001 … BUG-038** kako su bili zapisani u
> [BUGS.md](./BUGS.md) u trenutku rješavanja — s uzrokom, rješenjem i **lekcijom**, koja je jedini
> dio koji još vrijedi. Živi popis (aktivni + riješeni od 2026-08-31) ostaje u `BUGS.md`; ovamo se
> seli **samo cijeli riješeni bug**, nikad skraćen, i nikad se ovdje ne uređuje (2026-09-12, Leon:
> *„da bude lakše za čitat"*).
>
> Numeracija je uzlazna; poredak ovdje je onaj iz izvornika (najnoviji gore). Poveznice na kod
> pokazuju na stanje **tog dana** — datoteke su se odonda selile (npr. ADR-027, učitavanje po ruti).
...
mjere **kromo**, ne stranicu. Detaljno: [FRONTEND_REDIZAJN §9.2](../archive/FRONTEND_REDIZAJN.md).
