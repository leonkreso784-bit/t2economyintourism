...
**Sprint sad 4/7** (#1·#2·#5·#6). **PREOSTALO:** #3 backup (nizak prio, ne traži push) · #4 keep-alive (traži main-push) · #7 load-test+QA-sweep. **SLIJEDI:** dogovor s Leonom o sljedećoj cigli (#3/#7 idu odmah bez pusha; #4 + deploy #5 čekaju main-OK).
