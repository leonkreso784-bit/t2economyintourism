...
Osam pitanja koja mijenjaju izvedbu, a ne mogu se razumno pretpostaviti (dva riješena, šest otvorenih):
...
8. **Kraj špila** — zadnja kartica + palac desno (F1/13): samo odskok, ili ponuda „ponovi ne-znam" / „ispočetka"? Danas gumb „Znam" na zadnjoj kartici ostaje na njoj i ništa ne kaže. I: trebaju li ✓ / ✕ tipkovničke prečace na stolnom (npr. `1` / `2`), ili su strelice + razmak dovoljni? *(F1/13)*
