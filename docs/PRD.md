...
- **Sljedeće (engineering):** **U6 strukturne ops ✅ KOMPLETNE** (2026-07-17, grana `feature/u6-structural-ops`: kategorije + stavke — add/edit/reorder/remove; DB id-resync 16 eng. odrađen → item delete/reorder; živo verificirano authed 11/11) → **U7 learn-blokovi/renderer ✅ KOMPLETAN 2026-07-20** → **U8 vizualni editor „Studio" U TIJEKU** (zaokret: Studio-kosti prve, vizual zadnji; §12.2 — **U8.1–U8.5b ✅ 2026-07-22**: skelet + blok-editor + kartice/kviz/fill + inline-tekst + boja/link (U8.4b) + media slika/video (U8.5a/b); slijedi U8.5c formula → d tablica → e resize+callout → f boje sekcija → U8.6 vizual; ideje U8.7 upload-slika/U8.8 chart-blok zapisane) → F5 SRS → F6 sigurnost → UGC. Redoslijed = ADR-018. **Živi tracker: `EDITOR_PLAN.md` §12 + `HISTORY.md`.** (Usput 2026-07-15: BUG-020 kviz-curenje popravljen+deployan; management-hr content-rebalans → Saša.)
