...
- **Sljedeće (engineering):** **U6 strukturne ops ✅ KOMPLETNE** (2026-07-17, grana `feature/u6-structural-ops`: kategorije + stavke — add/edit/reorder/remove; DB id-resync 16 eng. odrađen → item delete/reorder; živo verificirano authed 11/11) → **U7 learn-blokovi/renderer ✅ KOMPLETAN 2026-07-20** → **U8 vizualni editor „Studio" U TIJEKU** (zaokret: Studio-kosti prve, vizual zadnji; §12.2 — **U8.1–U8.4a ✅ 2026-07-22**: skelet + blok-editor learn-pane + kartice/kviz/fill uredljivi + inline uređivanje teksta; slijedi U8.4b boja/link → U8.5 media → U8.6 vizual) → F5 SRS → F6 sigurnost → UGC. Redoslijed = ADR-018. **Živi tracker: `EDITOR_PLAN.md` §12 + `HISTORY.md`.** (Usput 2026-07-15: BUG-020 kviz-curenje popravljen+deployan; management-hr content-rebalans → Saša.)
