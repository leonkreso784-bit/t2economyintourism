...
- Sadržaj: **2. god HM = 8/8 ✅ + 1. god HM = 9/9 ✅ LIVE** (17 EN + **4 HR live**: business-informatics-hr + management-hr + **sit-hr + traffic-hr objavljeni 2026-07-22**; svi HR file-served). ⛔ Intro to Hospitality blokiran (nema PDF-ova). **HR program u tijeku** (Saša, content-suradnik — `docs/TEAM.md`).
...
- **Sljedeće (engineering):** **U6 strukturne ops ✅ KOMPLETNE** (2026-07-17, grana `feature/u6-structural-ops`: kategorije + stavke — add/edit/reorder/remove; DB id-resync 16 eng. odrađen → item delete/reorder; živo verificirano authed 11/11) → **U7 learn-blokovi/renderer ✅ KOMPLETAN 2026-07-20** → **U8 vizualni editor „Studio" U TIJEKU** (zaokret: Studio-kosti prve, vizual zadnji; §12.2 — **U8.1–U8.5d ✅ 2026-07-22**: skelet + blok-editor + kartice/kviz/fill + inline-tekst + boja/link + media slika/video/formula/tablica-2D-grid; **U8.9 math-tipkovnica (MathLive) ✅ INTEGRIRANA 2026-07-23** (a=`<math-field>` autorska strana lijeno + b/c=Casio-paleta template-gumba + KaTeX-renderirane labele; izlaz LaTeX→isti `tex`→student KaTeX NEPROMIJENJEN, student nikad ne učita MathLive) + **R1 grana-sync s main ✅** (sit-hr/traffic-hr ušli, 55↑/0↓); slijedi U8.5e resize+callout → f boje sekcija + U8.10 tablica-paste → U8.6 vizual; ideje U8.7 upload-slika/U8.8 chart-blok zapisane) → F5 SRS → F6 sigurnost → UGC. Redoslijed = ADR-018. **Živi tracker: `EDITOR_PLAN.md` §12 + `HISTORY.md`.** (Usput 2026-07-15: BUG-020 kviz-curenje popravljen+deployan; management-hr content-rebalans → Saša.)
