...
**🆕 NASTAVAK (2026-07-08→07-11, `foundation/f4` = preview):** ✅ F4.3c edit kartice end-to-end + propagacija na final · ✅ **F4.4 quiz/fill/learn editori** · Playwright LOGIN (`test:authed`). Nastavak F4 ide kroz **UGC-stazu** (`UGC.md` §12, model draft→objavi): ✅ **U1 staging Supabase** (`40dc07b`) · ✅ **U2a stabilni id-jevi na svih 18** (`b490172`, 2026-07-11). **⬜ DALJE: U2.5 (ADR-022) / U2b → U3 draft-sloj → U4 publish-RPC → …** — **živi tracker je odsad `UGC.md` §12** (ovaj ROADMAP je od F4 nadalje sažetak). Tim: **+Saša** (content, paralelna S-staza — `TEAM.md`).
