...
**🆕 NASTAVAK (2026-07-08→07-12, `foundation/f4` = preview):** ✅ F4.3c edit kartice end-to-end + propagacija na final · ✅ **F4.4 quiz/fill/learn editori** · Playwright LOGIN (`test:authed`). Nastavak F4 = **draft+editor staza** (`EDITOR_PLAN.md` §12, model draft→objavi; bivši UGC.md): ✅ **U1 staging Supabase** (`40dc07b`) · ✅ **U2a stabilni id-jevi na svih 18** (`b490172`) · ✅ **U2.5 placement dual-mode** (`b969892`, ADR-022) · 🟡 **U3 draft-sloj 2/3** (`281f5e3`+`468e477` — editori pišu u draft; ostaje d3 živa verifikacija Objavi-puta). **⬜ DALJE: U3-d3 → U4 publish-RPC → …** — **živi tracker je `EDITOR_PLAN.md` §12** (ovaj ROADMAP je od F4 nadalje sažetak). Tim: **+Saša** (content, paralelna S-staza — `TEAM.md`).
