...
- **B9 ✅ (kao F4.1, 2026-07-06)** — admin identitet (`profiles`+`is_admin()` RLS). **B10 🟡 (= F4/U-staza; dosadašnje cigle DEPLOYANE na produkciju 2026-07-13)** — admin CRUD (draft→objavi, `EDITOR_PLAN.md`; U4 publish-RPC ✅ + U-UX dizajn ✅ 🚀 DEPLOYANO na PROD 2026-07-14 (`79f17c7..056d963`); **U6 strukturne ops ✅ + U7 learn-blokovi/renderer ✅ → U8 vizualni editor „Studio" U TIJEKU (U8.1–U8.5b ✅ 2026-07-22: skelet+blok-editor+kartice/kviz/fill+inline-tekst+boja/link+media slika/video; slijedi U8.5c formula → d/e/f → U8.6 vizual; ideje U8.7 upload/U8.8 chart zapisane)**, grana `feature/u6-structural-ops`, PREVIEW); source-of-truth flip na bazu = U9+/F4.6.
