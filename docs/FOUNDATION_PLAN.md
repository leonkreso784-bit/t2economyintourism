...
- **2D — UI-primitivi = Web Components (S4):** *inkrementalno, light-DOM (bez Shadow DOM — čuva globalni CSS/teme).*
  ...
  - [2D.3] ✅ **GOTOVO (2026-07-04, grana `foundation/f2d3`; ▶ gate zelen, ide na prod):** prvi konzument = **`<sokrat-confirm>`** (branded confirm-dijalog, GRAĐEN NA `<sokrat-modal>` = prva kompozicija komponenti).
