...
> **Status (ažurirano 2026-07-14):** ▶ U TIJEKU. **F1 ✅ · F2 ✅ · F3 ✅ · F4 dosadašnje cigle 🚀 DEPLOYANE NA PRODUKCIJU 2026-07-13** (`5d24a96..79f17c7`: F4.1–4.4 + U1–U3 draft→objavi; studentima nevidljivo, sve iza `is_admin()`); ADR-021 + `CRUD_PLAN.md`. **Nastavak = draft+editor staza (`EDITOR_PLAN.md` §12): ✅ U1 · ✅ U2a · ✅ U2.5 · ✅ U3 · ✅ U4 publish-RPC · ✅ U-UX dizajn-faza (smjer C „Tok" → `EDITOR_UX.md` v0.9) — **oboje 🚀 DEPLOYANO na PROD 2026-07-14 (`79f17c7..056d963`)** → ✅ **U6 strukturne ops KOMPLETNE** (grana `feature/u6-structural-ops`, PREVIEW: kategorije + stavke add/edit/reorder/remove; DB id-resync 16 eng. odrađen 2026-07-17; authed 11/11) → C-vizual U8 → … Tim: +Saša (content, S-staza — `TEAM.md`).**
