...
> **Status (ažurirano 2026-07-14):** ▶ U TIJEKU. **F1 ✅ · F2 ✅ · F3 ✅ · F4 dosadašnje cigle 🚀 DEPLOYANE NA PRODUKCIJU 2026-07-13** (`5d24a96..79f17c7`: F4.1–4.4 + U1–U3 draft→objavi; studentima nevidljivo, sve iza `is_admin()`); ADR-021 + `CRUD_PLAN.md`. **Nastavak = draft+editor staza (`EDITOR_PLAN.md` §12): ✅ U1 · ✅ U2a · ✅ U2.5 · ✅ U3 · ✅ U4 publish-RPC · ✅ U-UX dizajn-faza (smjer C „Tok" → `EDITOR_UX.md` v0.9) — **oboje 🚀 DEPLOYANO na PROD 2026-07-14 (`79f17c7..056d963`)** → 🔄 **U6 strukturne ops U TIJEKU** (grana `feature/u6-structural-ops`, PREVIEW: ops-sloj + add-UI + kategorije-UI (U6d) ✅; brisanje/preslagivanje STAVKI čeka DB id-resync) → … Tim: +Saša (content, S-staza — `TEAM.md`).**
