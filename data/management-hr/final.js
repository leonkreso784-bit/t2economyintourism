...
const managementHrFinalExamPractice = {
  ...
  "flashcards": [
    ...
    {
      "question": "PONAVLJANJE ZA ISPIT: navedite ČETIRI funkcije menadžmenta i povežite svaku s odgovarajućim glavnim poglavljem.",
      "answer": "1. PLANIRANJE — donošenje odluka + strateško/operativno planiranje.\n2. ORGANIZIRANJE — organiziranje i delegiranje rada (+ kadroviranje u ULJ-u, timski rad).\n3. VOĐENJE — organizacijsko ponašanje, motivacija, liderstvo.\n4. KONTROLIRANJE — sustavi kontrole, financije i ljudi.\n\nOne su međusobno različite, ali i isprepletene te se provode istovremeno — NISU linearni koraci.",
      "explanation": "Cijeli kolegij strukturiran je oko četiri funkcije menadžmenta."
    },
    {
  ...
  "quiz": [
    ...
    {
      "question": "'Najbolji pristup ovisi o situaciji' temeljná je ideja:",
      "options": [
    ...
    {
      "question": "Koji je par točan?",
      "options": [
        "Maslow – dvofaktorska teorija",
        "Herzberg – hijerarhija potreba",
        "Vroom – teorija očekivanja",
        "Tuckman – stečene potrebe"
      ],
      "correct": 2
    },
    {
      "question": "U kojoj Tuckmannoj fazi se pojavljuje samousmjeravajući tim?",
      "options": [
        "Formiranje",
        "Olujanje",
        "Normiranje",
    ...
    {
      "question": "Na Mreži vodstva, idealni stil je:",
      "options": [
        "(1,1)",
        "(9,1)",
        "(1,9)",
    ...
    {
      "question": "Koji je instrument VLASNIČKOG/DIONIČKOG financiranja koji poduzeće nikada ne otplaćuje?",
      "options": [
        "Obveznice",
        "Dionice",
        "Zajmovi",
    ...
    {
      "question": "Prodaja proizvoda bliže krajnjem kupcu (npr. Apple Stores) jest:",
      "options": [
        "Unatražna integracija",
        "Unaprijedna integracija",
        "Diverzifikacija",
        "Koncentracija"
      ],
      "correct": 1
    ...
    {
      "question": "Koja kontrola predviđa i SPRJEČAVA probleme u fazi inputa?",
      "options": [
        "Tekuća (istodobna)",
        "Dorada",
        "Preliminarno (feedforward)",
        "Šteta"
      ],
      "correct": 2
    }
  ...
  "fillBlanks": [
    ...
    {
      "sentence": "Učinak = sposobnost × _______ × resursi.",
      "answer": "motivacija",
      "hint": "Spremnost na ostvarivanje ciljeva..."
    },
    {
      "sentence": "Najbolji pristup upravljanju ovisi o situaciji — to je _______ teorija.",
      "answer": "kontingencijska",
      "hint": "'Ovisi o okolnostima'..."
    },
    {
      "sentence": "Vroomova formula očekivanja glasi: očekivanje × instrumentalnost × _______.",
      "answer": "valencija",
      "hint": "Vrijednost nagrade..."
    },
    {
      "sentence": "U bilanci stanja, imovina = obveze + _______ vlasnika.",
      "answer": "glavnica",
      "hint": "Vlasnički udio..."
    }
  ],
