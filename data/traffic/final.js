...
const trafficExamPractice = {
    ...
    fillBlanks: [
        { id: "tva157", sentence: "Each mode is studied as a connector AND as part of the tourism _______.", answer: "product", hint: "when the trip is the attraction" },
        { id: "m32cqv", sentence: "Inelastic modes (rail/air/water) rely on _______ transport for the door-to-door part.", answer: "road", hint: "the elastic mode" },
        { id: "zva6q1", sentence: "Combining at least two transport branches in one trip is a _______ (combined) journey.", answer: "multimodal", hint: "many modes" },
        { id: "j93yax", sentence: "The greenest motorised mode, favoured by EU modal-shift policy, is _______.", answer: "rail", hint: "electric trains" },
        { id: "q7ni3z", sentence: "Transport causes about a _______ of EU greenhouse-gas emissions.", answer: "quarter", hint: "~25%" },
        { id: "09tzar", sentence: "The EU strategy aims to cut transport emissions by _______ % by 2050.", answer: "90", hint: "nine-zero" }
    ],
