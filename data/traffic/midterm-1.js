...
const trafficM1 = {
    ...
    theoreticalBasis: {
        ...
        fillBlanks: [
            { id: "bvt668", sentence: "Transport in tourism is usually _______, meaning it relies on more than one transport branch to complete the door-to-door chain.", answer: "multimodal", hint: "multi-…" },
            { id: "ksgg91", sentence: "Tourist transport demand is a _______ demand, because people travel in order to satisfy another need.", answer: "derived", hint: "not autonomous" },
            { id: "sj5uxo", sentence: "A transport service cannot be stored; this property is called _______.", answer: "perishability", hint: "an empty seat is lost" },
            { id: "5vjqrp", sentence: "The organised whole of infrastructure, vehicles and rules that make transport possible is the transport _______.", answer: "system", hint: "the whole" },
            { id: "igqprp", sentence: "Of all branches, _______ transport is the most elastic and the only true door-to-door mode.", answer: "road", hint: "cars/buses" },
            { id: "an71ms", sentence: "Transport _______ is the long-term plan through which the state guides the development of the transport system.", answer: "strategy", hint: "part of transport policy" },
            { id: "cjhy66", sentence: "Emissions, noise, congestion and accidents are the negative (external) _______ of transport.", answer: "effects", hint: "consequences" }
        ],
    ...
    trafficTourismInterdependence: {
        ...
        fillBlanks: [
            { id: "mqwimb", sentence: "Transport connects the _______ market with the receptive destination.", answer: "emitting", hint: "demand-generating / sending" },
            { id: "dha0zm", sentence: "When the ride itself is the attraction (a cruise, a scenic train), transport is part of the tourism _______.", answer: "product", hint: "the thing sold" },
            { id: "q30sn7", sentence: "The two-way relationship in which transport and tourism each drive the other is called _______.", answer: "interdependence", hint: "inter-…" },
            { id: "o6a65v", sentence: "How easily a destination can be reached is its transport _______, a key part of competitiveness.", answer: "accessibility", hint: "reachability" },
            { id: "law9hk", sentence: "Tourist transport demand is hard to serve because it is highly _______, peaking in summer/holidays.", answer: "seasonal", hint: "varies by season" },
            { id: "p6x4az", sentence: "The cost of the transport service is built into the final _______ of the tourism product.", answer: "price", hint: "what the tourist pays" },
            { id: "vj8cgn", sentence: "Low-_______ carriers expanded tourism by bringing air travel to people who previously could not afford it.", answer: "cost", hint: "budget airlines" }
        ],
    ...
    mobilityTravelPatterns: {
        ...
        fillBlanks: [
            { id: "l0bszo", sentence: "The _______ car is the dominant primary form of daily mobility in the EU.", answer: "passenger", hint: "private four-wheeler" },
            { id: "cdzxhg", sentence: "Car use as a share of daily mobility is generally higher in _______ areas than in big cities.", answer: "rural", hint: "countryside" },
            { id: "bzh29t", sentence: "The two top reasons for choosing a daily mode are comfort and _______ (time saving).", answer: "speed", hint: "how fast" },
            { id: "vqshz4", sentence: "The biggest challenges of daily mobility are the cost of transport and traffic _______.", answer: "congestion", hint: "traffic jams" },
            { id: "unt1xf", sentence: "For trips longer than 300 km, after the car the next most-used mode is the _______.", answer: "airplane", hint: "by air" },
            { id: "nmwgre", sentence: "The #1 condition for switching to a sustainable mode is that it must not be more _______ than the current one.", answer: "expensive", hint: "about price" },
            { id: "vzmp2n", sentence: "Citizens rate a single _______ valid for all urban transport modes as the most useful future innovation.", answer: "ticket", hint: "integrated fare" }
        ],
    ...
    roadTransportConnecting: {
        ...
        fillBlanks: [
            { id: "p9oo22", sentence: "Road transport is the only true _______-to-door mode, often needing no transfer.", answer: "door", hint: "door-to-door" },
            { id: "7vy0d5", sentence: "Road traffic appears in three organisational forms: own, line (public) and _______-purpose transport.", answer: "special", hint: "for closed groups etc." },
            { id: "nhf8xa", sentence: "A _______ has no own drive and is functionally attached to a car.", answer: "caravan", hint: "towed trailer-home" },
            { id: "ozpvn9", sentence: "A motorhome (campervan) has its own drive part, a cabin and a _______ space.", answer: "living", hint: "where you sleep/cook" },
            { id: "xcfyqy", sentence: "Agency-organised tourist trips by bus are the _______ form of bus transport.", answer: "occasional", hint: "not scheduled line" },
            { id: "41a71b", sentence: "The _______ is the most numerous road vehicle in tourism.", answer: "car", hint: "individual vehicle" },
            { id: "7vp6wq", sentence: "A one-time road fee usually does not cover the real cost, so road infrastructure is largely _______-financed.", answer: "state", hint: "public" }
        ],
    ...
    roadTransportProduct: {
        ...
        fillBlanks: [
            { id: "xngskm", sentence: "A one-day organised road tour is a bus _______.", answer: "excursion", hint: "short trip" },
            { id: "umvceo", sentence: "Sightseeing round-trips of a destination's sights by bus are _______ transport.", answer: "panoramic", hint: "scenic viewing" },
            { id: "ezo6kn", sentence: "Transport from airport to hotel or port to city, often combined with other modes, is a _______.", answer: "transfer", hint: "connecting leg" },
            { id: "dd4mnu", sentence: "A ski bus or beach bus is a type of local tourist _______.", answer: "line", hint: "regular route" },
            { id: "k94o04", sentence: "Rent-a-car payment can be based on distance travelled or on the _______ of the lease.", answer: "duration", hint: "how long" },
            { id: "n09s16", sentence: "Leisure travel where cycling is the primary part is called cycling _______.", answer: "tourism", hint: "the activity-based form" },
            { id: "m7crwj", sentence: "In the EU survey, low prices and not having a _______ are the top reasons to travel by coach.", answer: "car", hint: "own vehicle" }
        ],
    ...
    railTransportConnecting: {
        ...
        fillBlanks: [
            { id: "bzrz4j", sentence: "Rail's biggest advantages are large capacity, low costs and favourable safety and _______ indicators.", answer: "environmental", hint: "eco / nature" },
            { id: "5xs3v0", sentence: "Because it is bound to fixed lines and cannot do door-to-door, rail is relatively _______.", answer: "inelastic", hint: "not flexible" },
            { id: "fw1dq1", sentence: "On a train the locomotive (drive) is separate from the _______, which can be freely combined.", answer: "wagons", hint: "carriages/cars" },
            { id: "zqecr8", sentence: "Carriages for trips up to ~50 km, with modest equipment, are _______ carriages.", answer: "local", hint: "short distance" },
            { id: "vw5979", sentence: "Combined transport such as rail + road vehicles is called _______ transport.", answer: "intermodal", hint: "across modes" },
            { id: "7j08qc", sentence: "Unlike a road, a railway must be built as a _______, because of signalling and safety dependence.", answer: "whole", hint: "not in sections" },
            { id: "t0znwt", sentence: "High-speed rail is nearly nine times more energy-efficient than _______.", answer: "flying", hint: "air travel" }
        ],
