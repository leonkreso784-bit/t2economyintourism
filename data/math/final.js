...
const mathExamPractice = {
  ...
  fillBlanks: [
    { sentence: "Differentiation and integration are _______ operations.", answer: "inverse", hint: "One undoes the other" },
    { sentence: "Marginal cost is the derivative of total cost: M(Q) = T′(Q); total cost is the _______ of marginal cost.", answer: "integral", hint: "T(Q) = ∫ M(Q) dQ" },
    { sentence: "To maximise profit, solve D′(Q) = 0 and confirm with the _______ derivative test.", answer: "second", hint: "D″ < 0 for a maximum" },
    { sentence: "Elasticity E = (p/q)·(dq/dp); if |E| > 1 demand is _______.", answer: "elastic", hint: "Reacts more than proportionally" },
    { sentence: "A loan equals the _______ value of its future repayments (an annuity).", answer: "present", hint: "Discounted to today" },
    { sentence: "A linear system reduces (Gauss-Jordan) to the _______ matrix when it has a unique solution.", answer: "identity", hint: "1s on the diagonal" }
  ],
