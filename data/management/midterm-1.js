...
// Part II Planning + Part III Organizing → the first three management functions plus history.
//   1. Management & Its History (TU2)   2. Problem Solving & Decision Making (TU3)
//   3. Strategic & Operational Planning (TU4)   4. Organizing & Delegating Work (TU5)
//   5. Managing Teamwork (TU6)   6. Human Resource Management (TU7)
    ...
    foundations: {
        ...
        quiz: [
            {
                ...
                options: [
                    ...
                    "Hiring, budgeting, producing, reporting",
        ...
        learn: {
            ...
            content: `
                ...
                <p>Working with <strong>human, financial, physical and informational</strong> resources to achieve
                organizational objectives by performing four functions.</p>
                <div class="formula-box">
                    EFFICIENT = doing things RIGHT (least waste) &nbsp;·&nbsp; EFFECTIVE = doing the RIGHT thing<br>
                    PLANNING → ORGANIZING → LEADING → CONTROLLING (distinct yet interrelated)
                </div>

                <h4>Skills, roles & levels</h4>
                <ul>
                    <li><strong>Skills:</strong> technical (hard) · interpersonal (soft) · decision-making (conceptual)</li>
                    <li><strong>Mintzberg's 10 roles</strong> → interpersonal · informational · decisional</li>
                    <li><strong>Levels:</strong> top · middle · first-line (+ team leader, operatives)</li>
                </ul>

                <h4>Schools of management thought</h4>
                <div class="tip-box">
                    <ul>
                        <li><strong>Classical</strong> (the job): Taylor (scientific mgmt), Fayol (administrative), Weber (bureaucracy), Follett (people)</li>
                        <li><strong>Behavioral</strong> (people): Mayo (human relations), Maslow (needs), McGregor (Theory X/Y)</li>
                        <li><strong>Management science</strong> (math): operations research, MIS</li>
                        <li><strong>Integrative</strong>: systems · sociotechnical · contingency ("it depends")</li>
                    </ul>
                </div>
            `
        }
    ...
    decisionMaking: {
        ...
        quiz: [
            {
                ...
                options: [
                    "Sales are high",
                    "Objectives are not being met (a gap between actual and desired)",
                    "Employees are happy",
            ...
            },
            {
                ...
                options: [
                    ...
                    "Pick the first option meeting minimum criteria",
                    "Refuse to decide",
                    "Always use math models"
                ],
                correct: 1
            },
            {
        ...
        learn: {
            ...
            content: `
                ...
                <p>A <strong>problem</strong> = a gap between what is and what you want. <strong>Problem solving</strong>
                takes corrective action; <strong>decision making</strong> selects the action.</p>

                <div class="formula-box">
                    6-STEP MODEL: classify/define → set objectives & criteria → generate alternatives →
                    analyze & select → plan/implement → control
                </div>

                <h4>Classifying the decision</h4>
                <ul>
                    <li><strong>Structure:</strong> programmed (routine, use rules) vs nonprogrammed (significant, use the model)</li>
                    <li><strong>Conditions:</strong> certainty · risk (probabilities) · uncertainty</li>
                    <li><strong>Type of maker:</strong> maximizer (rational, best) vs satisficer (bounded, "good enough")</li>
                </ul>

                <h4>Generating & analyzing alternatives</h4>
                <div class="tip-box">
                    <p><strong>Creativity</strong> drives <strong>innovation</strong> (product & process).
                    Group techniques: brainstorming · synectics · nominal grouping · consensus mapping · Delphi.
                    Quantitative tools: break-even · capital budgeting · linear programming · queuing · probability · big data.
                    Mixed: cost-benefit (+ opportunity cost, pros & cons, intuition).</p>
                </div>
            `
        }
    },
    ...
    strategicPlanning: {
        ...
        learn: {
            ...
            content: `
                ...
                <div class="formula-box">
                    STRATEGIC (long-range, mission, top/middle) &nbsp;vs&nbsp; OPERATIONAL (≤1 year, functional)<br>
                    LEVELS: corporate (many businesses) · business (one) · functional (one area)
                </div>

                <h4>The 5-step strategic planning process</h4>
                <ol>
                    <li>Develop the <strong>mission</strong> (foundation)</li>
                    <li>Analyze the <strong>environment</strong> — SWOT + Porter's five forces</li>
                    <li>Set <strong>objectives</strong> (SMART)</li>
                    <li>Develop <strong>strategies</strong> (corporate / business / functional)</li>
                    <li>Implement & <strong>control</strong></li>
                </ol>

                <h4>Strategy menu</h4>
                <div class="tip-box">
                    <ul>
                        <li><strong>Grand:</strong> growth · stability · turnaround & retrenchment · combination</li>
                        <li><strong>Growth:</strong> concentration · integration (forward/backward) · diversification (related/unrelated) · M&A</li>
                        <li><strong>BCG:</strong> cash cows · stars · question marks · dogs</li>
                        <li><strong>Adaptive:</strong> prospecting · defending · analyzing</li>
                        <li><strong>Porter competitive:</strong> differentiation · cost leadership · focus</li>
                        <li><strong>Plans:</strong> standing (policy/procedure/rule) · single-use (program/budget) · contingency</li>
                    </ul>
                </div>
            `
        }
    ...
    organizing: {
        ...
        learn: {
            ...
            content: `
                ...
                <div class="formula-box">
                    MECHANISTIC (rules, tight control, specialized, top-down) ← → ORGANIC (flexible, broad jobs, lower-level decisions)<br>
                    Stable environment → mechanistic &nbsp;·&nbsp; Dynamic environment → organic
                </div>

                <h4>Principles & authority</h4>
                <ul>
                    <li>Unity of command/direction · chain of command · span of management · division of labor · coordination</li>
                    <li>Responsibility & authority flow <strong>down</strong>; accountability flows <strong>up</strong>; delegation needs a NEW task</li>
                    <li>Authority vs power · line vs staff · centralized vs decentralized · 4 levels (inform/recommend/report/full)</li>
                </ul>

                <h4>Structure & jobs</h4>
                <div class="tip-box">
                    <ul>
                        <li><strong>Departmentalization:</strong> functional · product · customer · territory · divisional · matrix</li>
                        <li><strong>Contemporary designs:</strong> team · network · modular · virtual · platform (+ reengineering)</li>
                        <li><strong>Job design:</strong> simplification vs expansion (rotation · enlargement · enrichment)</li>
                    </ul>
                </div>
            `
        }
    ...
    teamwork: {
        ...
        learn: {
            ...
            content: `
                <h3>Group vs team</h3>
                <div class="formula-box">
                    GROUP: clear leader · independent jobs · individual accountability<br>
                    TEAM: shared leadership · interdependent jobs · individual + group accountability
                </div>

                <h4>Group performance model</h4>
                <p>performance = f(organizational <strong>context</strong> · <strong>structure</strong> ·
                <strong>process</strong> · <strong>development</strong>). The <em>systems effect</em> links every
                group to the whole organization.</p>

                <ul>
                    <li><strong>Structure:</strong> type · size (5–9 / two-pizza rule) · composition · leadership · objectives</li>
                    <li><strong>Process:</strong> roles · norms · cohesiveness · status · decisions · conflict</li>
                </ul>

                <h4>Tuckman's stages → management style</h4>
                <div class="tip-box">
                    <ul>
                        <li>Forming → <strong>autocratic</strong></li>
                        <li>Storming → <strong>consultative</strong></li>
                        <li>Norming → <strong>participative</strong></li>
                        <li>Performing → <strong>empowerment</strong> (self-directed team)</li>
                        <li>Termination → no style needed</li>
                    </ul>
                </div>
            `
        }
    ...
    humanResources: {
        ...
        learn: {
            ...
            content: `
                ...
                <div class="formula-box">
                    PLAN → ATTRACT (recruit + select) → DEVELOP (orient, train, appraise) → RETAIN (compensate)
                </div>

                <h4>Attracting</h4>
                <ul>
                    <li><strong>Job analysis</strong> → job description (tasks) + job specifications (qualifications)</li>
                    <li><strong>Recruiting</strong> (qualified candidates): internal mobility · referrals · agencies · ads/social</li>
                    <li><strong>Selection (6 steps):</strong> application → screening → testing (validity & reliability) → background → interview → hire</li>
                </ul>

                <h4>Developing & retaining</h4>
                <div class="tip-box">
                    <ul>
                        <li><strong>Onboarding</strong> + socialization; <strong>training</strong> (current job) vs <strong>development</strong> (future)</li>
                        <li><strong>Performance appraisal</strong> (incl. 360-degree feedback)</li>
                        <li><strong>Compensation</strong> = pay + benefits; methods: wages · salary · incentives</li>
                        <li>Labor unions & labor relations (collective bargaining)</li>
                    </ul>
                </div>
            `
        }
...
if (typeof window !== "undefined") { window.managementM1 = managementM1; }
if (typeof module !== "undefined" && module.exports) { module.exports = managementM1; }
