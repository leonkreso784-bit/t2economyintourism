...
const businessInformaticsM1 = {
  ...
  dataInfoKnowledge: {
    ...
    quiz: [
      { id: "tvzev0", question: 'Raw facts and figures that have no meaning on their own are:', options: ['Information', 'Data', 'Knowledge', 'Wisdom'], correct: 1 },
      { id: "72nrjk", question: '"The hotel’s July occupancy rate was 85%" is an example of:', options: ['Data', 'Information', 'Knowledge', 'Noise'], correct: 1 },
      { id: "bo799d", question: 'The ability to interpret information and apply it to make decisions is:', options: ['Data', 'Information', 'Knowledge', 'Input'], correct: 2 },
      { id: "a27429", question: 'Data becomes information when it is:', options: ['Deleted', 'Processed within a context', 'Stored on disk', 'Encrypted'], correct: 1 },
      { id: "ihbilf", question: '"Predicting high demand for rooms in summer from occupancy rates" is an example of:', options: ['Data', 'Information', 'Knowledge', 'Feedback'], correct: 2 }
    ],

    fillBlanks: [
      { id: "lh2a2x", sentence: '_______ are raw facts and figures that on their own have no meaning.', answer: 'data', hint: 'Raw facts and numbers.' },
      { id: "n8zfr1", sentence: 'Information is data that has been processed within a _______ to give it meaning.', answer: 'context', hint: 'The situation that gives meaning.' },
      { id: "t51nxo", sentence: '_______ is the ability to interpret information and apply it to solve problems.', answer: 'knowledge', hint: 'Comes after information.' },
      { id: "c0bvyj", sentence: '"100 guests checked in yesterday" is an example of _______ in the hotel industry.', answer: 'data', hint: 'A raw fact.' }
    ],
  ...
  hardware: {
    ...
    quiz: [
      { id: "6392nd", question: 'The most important component, which actually runs programs, is the:', options: ['RAM', 'CPU', 'SSD', 'Monitor'], correct: 1 },
      { id: "wfztdd", question: 'RAM is described as ____ memory (its contents are erased when power is off):', options: ['Permanent', 'Volatile', 'Optical', 'Secondary'], correct: 1 },
      { id: "0b2iqp", question: 'Which of these is an example of secondary storage?', options: ['CPU', 'RAM', 'SSD', 'Keyboard'], correct: 2 },
      { id: "meyp7g", question: 'A keyboard is an example of a(n):', options: ['Output device', 'Input device', 'Storage device', 'Processor'], correct: 1 },
      { id: "wy6mhx", question: 'Which secondary storage has no moving parts and is faster than a disk drive?', options: ['HDD', 'SSD', 'CD', 'Floppy disk'], correct: 1 }
    ],

    fillBlanks: [
      { id: "5dt9ma", sentence: 'The _______ is the component that actually runs programs and is the most important part of the computer.', answer: 'CPU', hint: 'Central Processing Unit.' },
      { id: "xaeqrt", sentence: 'RAM is _______ memory, so its contents are erased when the computer is turned off.', answer: 'volatile', hint: 'Lost without power.' },
      { id: "ifb1vz", sentence: 'An _______ device collects data from people, e.g. a keyboard or mouse.', answer: 'input', hint: 'Opposite of output.' },
      { id: "u2xeso", sentence: 'An _______ (no moving parts) is faster than a magnetic disk drive.', answer: 'SSD', hint: 'Solid State Drive.' }
    ],
  ...
  software: {
    ...
    quiz: [
      { id: "upp6s7", question: 'Software is best described as:', options: ['Physical devices', 'A set of instructions that tell a computer what to do', 'A type of CPU', 'A network'], correct: 1 },
      { id: "dbpfpi", question: 'The two main types of software are:', options: ['Input & output', 'System & application', 'RAM & ROM', 'LAN & WAN'], correct: 1 },
      { id: "lee10k", question: 'Microsoft Excel and Google Docs are examples of:', options: ['System software', 'Application software', 'Firmware', 'Device drivers'], correct: 1 },
      { id: "e7ason", question: 'Which acts as the interface between applications and the hardware?', options: ['Spreadsheet', 'Operating system', 'Browser', 'NIC'], correct: 1 },
      { id: "6pmn40", question: 'Which is an example of system software?', options: ['Adobe Photoshop', 'Operating system', 'Microsoft Word', 'Google Chrome'], correct: 1 }
    ],

    fillBlanks: [
      { id: "mq1vhk", sentence: '_______ is a set of instructions that tells a computer how to function.', answer: 'software', hint: 'Opposite of hardware.' },
      { id: "hiemq0", sentence: '_______ software helps the end user complete tasks like writing documents or editing photos.', answer: 'application', hint: 'Sits above system software.' },
      { id: "xylk24", sentence: 'The _______ system is system software that manages all programs and interfaces with the hardware.', answer: 'operating', hint: 'OS.' },
      { id: "y5voiv", sentence: '_______ is built-in firmware that sets what a computer can do without accessing programs from a disk.', answer: 'BIOS', hint: 'Basic Input/Output System.' }
    ],
  ...
  networks: {
    ...
    quiz: [
      { id: "824uh2", question: 'A computer network lets connected computers share:', options: ['Only electricity', 'Data, resources and applications', 'Nothing', 'Only printers'], correct: 1 },
      { id: "njm2fg", question: 'A network limited to an office or apartment is a:', options: ['WAN', 'LAN', 'GAN', 'MAN'], correct: 1 },
      { id: "0v2htn", question: 'A network covering a whole city by connecting several LANs is a:', options: ['PAN', 'LAN', 'MAN', 'NIC'], correct: 2 },
      { id: "7hyr54", question: 'The unique hardware address of a NIC is called the ___ address:', options: ['IP', 'MAC', 'URL', 'DNS'], correct: 1 },
      { id: "1hhfw3", question: 'Which device has all capabilities and can connect LANs over great distances via a WAN?', options: ['Hub', 'Repeater', 'Router', 'Bridge'], correct: 2 }
    ],

    fillBlanks: [
      { id: "yn27wj", sentence: 'A computer _______ is two or more computers connected to share data and resources.', answer: 'network', hint: 'The topic of this chapter.' },
      { id: "lk18bn", sentence: 'A _______ (Local Area Network) connects computers within a limited area like an office.', answer: 'LAN', hint: 'Smallest type.' },
      { id: "5is15r", sentence: 'Each NIC is identified by a unique _______ address.', answer: 'MAC', hint: 'Media Access Control.' },
      { id: "kqys3y", sentence: 'A _______ can connect to a WAN and link LANs separated by great distances.', answer: 'router', hint: 'Most capable node.' }
    ],
  ...
  www: {
    ...
    quiz: [
      { id: "zgf9zj", question: 'The Internet is best described as:', options: ['A collection of web pages', 'An enormous network of networks', 'A web browser', 'A search engine'], correct: 1 },
      { id: "xml6uu", question: 'The World Wide Web is:', options: ['Exactly the same as the Internet', 'A service provided by the Internet (linked web pages)', 'A type of cable', 'A type of CPU'], correct: 1 },
      { id: "17ujmi", question: 'DNS maps domain names to:', options: ['MAC addresses', 'IP addresses', 'Web browsers', 'Packets'], correct: 1 },
      { id: "qiicr6", question: 'Which protocol is used to transfer web pages?', options: ['FTP', 'HTTP', 'SMTP', 'POP'], correct: 1 },
      { id: "0287pw", question: 'In the web client/server model, the client is usually the:', options: ['Web server', 'Web browser', 'DNS server', 'Router'], correct: 1 }
    ],

    fillBlanks: [
      { id: "qvgzci", sentence: 'The _______ is an enormous network of networks connecting devices via cables, wireless and fibre.', answer: 'Internet', hint: 'The infrastructure.' },
      { id: "cvbr9h", sentence: 'The World Wide Web is a collection of web pages linked by _______.', answer: 'hyperlinks', hint: 'Clickable links.' },
      { id: "vi36iq", sentence: '_______ maps memorable domain names to numeric IP addresses.', answer: 'DNS', hint: 'Domain Name System.' },
      { id: "2le9md", sentence: 'The Web uses the _______ protocol to transmit web pages.', answer: 'HTTP', hint: 'HyperText Transfer Protocol.' }
    ],
