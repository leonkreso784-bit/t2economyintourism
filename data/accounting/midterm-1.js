...
const accountingM1 = {
    ...
    intro: {
        ...
        fillBlanks: [
            { id: "xz0qa0", sentence: "The accounting equation is Assets = Liabilities + Owners' _______.", answer: "Equity", hint: "Owners' claim on assets" },
            { id: "dx0okz", sentence: "_______ accounting prepares reports for external users following GAAP.", answer: "Financial", hint: "External, not internal" },
            { id: "10pyvl", sentence: "_______ accounting serves internal management with budgets and forecasts.", answer: "Managerial", hint: "Internal decision-making" },
            { id: "9n6d2f", sentence: "GAAP stands for Generally Accepted Accounting _______.", answer: "Principles", hint: "The common rules" },
            { id: "iz7sy5", sentence: "The _______ entity assumption keeps the owner's personal affairs separate from the business.", answer: "business", hint: "Separate economic unit" },
            { id: "khtmie", sentence: "The _______ principle records assets at their original purchase price.", answer: "cost", hint: "Historical, not market" },
            { id: "2cug08", sentence: "The _______ principle records expenses in the same period as the revenue they generate.", answer: "matching", hint: "Pair cost with revenue" },
            { id: "xictpi", sentence: "Under double-entry accounting, total debits must equal total _______.", answer: "credits", hint: "Other side of the entry" },
            { id: "bdz9zv", sentence: "The _______ board (FASB) sets GAAP in the United States.", answer: "Financial Accounting Standards", hint: "F-A-S-B" },
            { id: "2yb6pf", sentence: "The _______ concern assumption presumes the business will keep operating.", answer: "going", hint: "Not about to be liquidated" }
        ],
    ...
    businessFormation: {
        ...
        fillBlanks: [
            { id: "v94rfm", sentence: "A _______ study is performed before starting a business to assess its viability.", answer: "feasibility", hint: "Is it practical / will it succeed?" },
            { id: "pege68", sentence: "A sole proprietor has _______ liability for the debts of the business.", answer: "unlimited", hint: "Personal assets at risk" },
            { id: "z85gvk", sentence: "A _______ is a separate legal entity owned by stockholders.", answer: "corporation", hint: "A 'legal person'" },
            { id: "dkisw5", sentence: "Stockholders enjoy _______ liability, risking only what they invested.", answer: "limited", hint: "Opposite of unlimited" },
            { id: "zvng64", sentence: "Corporate profits face _______ taxation — at the corporation and again as dividends.", answer: "double", hint: "Taxed twice" },
            { id: "b4bxu8", sentence: "An _______ combines limited liability with pass-through taxation.", answer: "LLC", hint: "Limited Liability Company" },
            { id: "uqrqkc", sentence: "Authorized ≥ Issued ≥ _______ shares.", answer: "Outstanding", hint: "Still held by investors" },
            { id: "38iwnj", sentence: "The nominal amount assigned to a share in the charter is its _______ value.", answer: "par", hint: "Not market value" },
            { id: "ulv9ea", sentence: "Amounts received above par are recorded as Additional _______ Capital.", answer: "Paid-In", hint: "APIC" },
            { id: "9fysxn", sentence: "_______ stock is a company's own shares that it has bought back.", answer: "Treasury", hint: "Reacquired shares" }
        ],
    ...
    financialStatements: {
        ...
        fillBlanks: [
            { id: "x08qgo", sentence: "The _______ sheet reports assets, liabilities, and equity at a point in time.", answer: "balance", hint: "A = L + E snapshot" },
            { id: "yckalv", sentence: "The income statement reports revenues and expenses over a _______ of time.", answer: "period", hint: "Not a single date" },
            { id: "859kll", sentence: "Revenue − Cost of Sales = _______ Profit.", answer: "Gross", hint: "First profit subtotal" },
            { id: "yvo7wz", sentence: "Net Income = Total Revenues − Total _______.", answer: "Expenses", hint: "The bottom line" },
            { id: "r8oaz1", sentence: "Beginning RE + Net Income − Dividends = Ending Retained _______.", answer: "Earnings", hint: "What's kept in the business" },
            { id: "7njj0u", sentence: "Rent, depreciation, and interest are examples of _______ charges.", answer: "fixed", hint: "Don't vary with sales" },
            { id: "c2wh7p", sentence: "The statement of cash flows is split into operating, investing, and _______ activities.", answer: "financing", hint: "Loans, stock, dividends" },
            { id: "8jjui8", sentence: "A _______ year is any 12-month accounting period a business chooses.", answer: "fiscal", hint: "Need not end Dec 31" },
            { id: "pg7wnp", sentence: "_______ statements are prepared monthly or quarterly.", answer: "Interim", hint: "Shorter than a year" }
        ],
    ...
    balanceSheet: {
        ...
        fillBlanks: [
            { id: "4ggy59", sentence: "The balance sheet satisfies Assets = Liabilities + Owners' _______.", answer: "Equity", hint: "Third element of the equation" },
            { id: "844bx2", sentence: "Assets expected to become cash within a year are _______ assets.", answer: "current", hint: "Short-term" },
            { id: "0ekf3h", sentence: "Prepaid rent and prepaid insurance are _______ expenses (an asset).", answer: "prepaid", hint: "Paid in advance" },
            { id: "vrmo8y", sentence: "Accounts payable and accrued expenses are _______ liabilities.", answer: "current", hint: "Due within a year" },
            { id: "40tgz6", sentence: "Guest _______ deposits are an unearned-revenue liability.", answer: "advance", hint: "Paid before the stay" },
            { id: "w4l0lu", sentence: "Working capital = current assets − current _______.", answer: "liabilities", hint: "Short-term obligations" },
            { id: "e0oir0", sentence: "Property and equipment is shown at cost minus accumulated _______.", answer: "depreciation", hint: "Used-up portion of cost" },
            { id: "ok7y8u", sentence: "Current assets are listed in order of _______.", answer: "liquidity", hint: "How fast they become cash" },
            { id: "ce6ey4", sentence: "_______ stock reduces total owners' equity.", answer: "Treasury", hint: "Reacquired shares" }
        ],
    ...
    incomeStatement: {
        ...
        fillBlanks: [
            { id: "3eoul6", sentence: "Revenue is recognized when it is _______, not when cash is received.", answer: "earned", hint: "Service provided / goods delivered" },
            { id: "8dnlto", sentence: "Sales tax collected from guests is a _______, not revenue.", answer: "liability", hint: "Owed to the government" },
            { id: "sqgs0z", sentence: "Tips collected for staff are a liability until _______ to employees.", answer: "paid", hint: "Handed over to staff" },
            { id: "ijrfkd", sentence: "Revenue − Cost of Sales = _______ Profit.", answer: "Gross", hint: "First profit subtotal" },
            { id: "59av8g", sentence: "In a _______ system, inventory updates continuously with each sale.", answer: "perpetual", hint: "Real-time" },
            { id: "y82j3v", sentence: "In a periodic system, Cost of Sales = Beginning + Purchases − _______ inventory.", answer: "Ending", hint: "Counted at period end" },
            { id: "ive5if", sentence: "_______ expense allocates an asset's cost to the current period.", answer: "Depreciation", hint: "Using up a long-lived asset" },
            { id: "t8fwqk", sentence: "Accumulated depreciation is a _______-asset that reduces property and equipment.", answer: "contra", hint: "Offsets an asset" },
            { id: "vyheza", sentence: "Food cost percentage = cost of food sold ÷ food _______.", answer: "sales", hint: "Revenue from food" }
        ],
    ...
    bookkeeping: {
        ...
        fillBlanks: [
            { id: "5ih3x8", sentence: "In double-entry accounting, total debits must equal total _______.", answer: "credits", hint: "The other side" },
            { id: "04oo6b", sentence: "Debits increase assets and _______.", answer: "expenses", hint: "Costs of operating" },
            { id: "hswxto", sentence: "Credits increase liabilities, equity, and _______.", answer: "revenue", hint: "Income earned" },
            { id: "knmpxc", sentence: "On a T-account, debits go on the _______ side.", answer: "left", hint: "Opposite of right" },
            { id: "wwwmi7", sentence: "The normal balance of an asset is a _______.", answer: "debit", hint: "Increasing side of an asset" },
            { id: "4ndjym", sentence: "The _______ is the book of original entry; the ledger holds the accounts.", answer: "journal", hint: "Recorded in date order" },
            { id: "ogits0", sentence: "Transferring journal entries to the ledger is called _______.", answer: "posting", hint: "Journal → ledger" },
            { id: "ktxi9a", sentence: "A _______ account has a normal balance opposite to the account it offsets.", answer: "contra", hint: "E.g. accumulated depreciation" },
            { id: "xqqt8l", sentence: "The _______ balance lists all accounts to check that debits equal credits.", answer: "trial", hint: "Pre-statement check" },
            { id: "b9lhi8", sentence: "In K1, journal entries use only Assets, Liabilities, and _______.", answer: "Equity", hint: "A / L / E" }
        ],
