    ...
    learn: {
        ...
        content: `
            ...
            <div class="tip-box" style="text-align: center; background: linear-gradient(135deg, rgba(124, 58, 237, 0.1), rgba(124, 58, 237, 0.2)); border-left-color: #7c3aed;">
                <h4 style="color: #7c3aed; font-size: 1.2rem;">📊 Financial Analysis = Understanding the Numbers</h4>
                <p style="margin: 0;">Ratios • Trends • Comparisons • CPA Services</p>
            </div>
            ...
            <h4>📈 Types of Financial Analysis</h4>
            
            <div class="formula-box">
                <strong>HORIZONTAL ANALYSIS:</strong><br>
                • Compares same item across different TIME PERIODS<br>
                • Identifies trends and changes<br>
                • Example: Revenue 2023 vs Revenue 2024<br>
                • Also called "Trend Analysis"<br><br>
                
                <strong>VERTICAL ANALYSIS:</strong><br>
                • Compares each item to a BASE within SAME PERIOD<br>
                • Shows percentage composition<br>
                • Balance Sheet base = Total Assets<br>
                • Income Statement base = Total Revenue<br>
                • Also called "Common-Size Analysis"
            </div>
            
            <hr>
            
            <h4>📊 Categories of Financial Ratios</h4>
            ...
            <div class="formula-box">
                ...
                <strong>Earnings Per Share (EPS)</strong> = (Net Income − Preferred Dividends) ÷ Weighted Avg Common Shares<br>
            ...
            <h4>👔 CPA Services (Three Levels of Assurance)</h4>
            ...
            <h4>📋 Five Types of Audit Opinions</h4>
            
            <div class="formula-box">
                <strong>1. Unqualified (Clean)</strong> ✅<br>
                • BEST opinion - no problems found<br>
                • Statements fairly presented per GAAP<br><br>
                
                <strong>2. Unqualified with Explanatory Paragraph</strong><br>
                • Clean opinion with added explanation<br>
                • Going concern issues, consistency changes<br><br>
                
                <strong>3. Qualified</strong><br>
                • Minor issues or scope limitations<br>
                • "Except for..." language<br><br>
                
                <strong>4. Adverse</strong> ❌<br>
                • WORST opinion - major GAAP violations<br>
                • Statements NOT fairly presented<br><br>
                
                <strong>5. Disclaimer</strong><br>
                • Auditor cannot express opinion<br>
                • Insufficient evidence or severe scope limitations
            </div>
            
            <hr>
            
            <h4>🏨 Hospitality-Specific Ratio</h4>
            
            <div class="example-box">
                <h4>📝 Hospitality Current Ratio</h4>
            ...
            <h4>👥 Who Uses Financial Ratios?</h4>
            <ul>
