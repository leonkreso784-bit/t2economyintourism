...
(function () {
  ...
  const DICT = {
    ...
    'materials.desc': { en: 'Build your own study material — organise it in folders however you like. Private to you.', hr: 'Gradi vlastito gradivo — složi ga u foldere kako god želiš. Vidljivo samo tebi.' },
    'materials.newFolder': { en: 'New folder', hr: 'Novi folder' },
    'materials.newStudy': { en: 'New material', hr: 'Novo gradivo' },
    'materials.addFolderIn': { en: 'New folder inside', hr: 'Novi folder unutra' },
    'materials.addStudyIn': { en: 'New material inside', hr: 'Novo gradivo unutra' },
    ...
    'materials.emptySub': { en: 'Create a folder to organise your studies, or a material to start building.', hr: 'Napravi folder da posložiš gradivo ili odmah kreni graditi novo gradivo.' },
    ...
    'materials.errCycle': { en: 'A folder cannot be moved into itself.', hr: 'Folder se ne može premjestiti u samog sebe.' },
    'materials.errNotFolder': { en: 'Only folders can contain items.', hr: 'Samo folder može sadržavati stavke.' },
    'materials.errParentDeleted': { en: 'Restore the parent folder first.', hr: 'Prvo vrati nadređeni folder.' },
    ...
    'materials.open': { en: 'Edit material', hr: 'Uredi gradivo' },
    ...
    'studio.nodeHint': { en: 'Personal material — only you can see it.', hr: 'Osobno gradivo — vidiš ga samo ti.' },
    'studio.loadingNode': { en: 'Loading your material…', hr: 'Učitavam gradivo…' },
