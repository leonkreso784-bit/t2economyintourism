...
**F1 uređaj: F1/1–11 ✅ · F1/12 kadar + F1/13 listanje = Tinder-kadar (Leon 06.09., izmjereno, plan u RASPORED-u).** iPhone još presuđuje F1/7 `?bez=` A/B i F1/11 štipanje (ADR-034).
