...
- **Napomene:** ⚠️ **22 test-audit-reda (te2) u `content_versions`** (PROD) iz živih proba — bezopasni; brisanje SAMO uz izričit OK (append-only audit) · CI `authed` job čeka repo-secrete (korisnik javio „riješeno") ·
