...
- **▶ FAZA 3 (performanse) KREĆE (2026-07-04/05, grana `foundation/f3`; NIJE deployano):** redoslijed = najsigurnija cigla prva → **3C → 3B → 3A → 3D → 3E** (SW zadnja, najrizičnija).
  ...
  **⬜ DALJE: push grane → CI → deploy F3 (uz izričitu potvrdu)** → **3C.2** (auto-bump na Vercel deploy-u) → 3D/3E. **🧭 Nakon F3: F4 CRUD → F5 SRS → F6 sigurnost → UGC → tek onda nazad na sadržaj (ADR-018).** [[foundation-pivot]]
