...
- **🎯 SLJEDEĆI RAD NIJE DOGOVOREN** (Leon, 2026-08-07). `docs/plan/` **nema aktivnog spec-a** — sljedeća faza ga dobiva kad se dogovori. Otvoreno stoji u **`docs/records/BACKLOG.md`**: M5a/M5b (duljina kartice, strop 500) · akcent treba obojati **cijelu** karticu, ne samo rub. Zapisana sekvenca dalje: **frontend redizajn** → **objava/dijeljenje + MCP**. ⚠️ **Matura = IZBAČENA.**
- **NA PRODU** (token `20260808010805`; SHA i Vercel-ref = zadnji „🚀" redak u `CHANGELOG.md`): **22 predmeta** (17 EN u Supabase + 5 HR file-served) · auth + cloud-sync + profil + GDPR · **Studio editor** (admin) · **osobni UGC-graditelj „Moji materijali"** · **faza „Materijal od nule do učenja"** — materijal se gradi od nule, iz njega se uči, boje sekcije vidljive u sva 4 moda · rizik-sprint 7/7 · GA4 + Sentry (consent-gated) · SW offline · i18n HR/EN · CI + deploy-guard. Tablica predmeta: `docs/subjects/README.md`.
