...
|---|---|---|---|
| **F1–F6** | `docs/FOUNDATION_PLAN.md` · `docs/ROADMAP.md` | faze **platformskog temelja** (CI/CD · jezgra · performanse · **Admin CRUD** · SRS · sigurnost) | F1–F4 isporučeni i na produkciji; **F5 SRS / F6 = NADGLAŠENI** (Leon 2026-08-02) |
| **F0–F5** | **`docs/CREATE_BACKEND_SPEC.md`** | faze **osobnog UGC-graditelja** (spec · DB · „Moji materijali" · editor u čvoru · polish · **PROD**) | **F0–F5 ✅ SVE ISPUNJENO** (F5 na produkciji 2026-08-06, §15) |
| **U· / F7·/ K·** | `docs/EDITOR_PLAN.md` | cigle Studio-editora | editor funkc. gotov |

Kad vidiš „F4" bez konteksta — provjeri **koji** je dokument izvor. **Oba niza su ISPUNJENA; sljedeći rad = frontend redizajn.**

## Stanje — TRENUTNO (2026-08-06; povijest: `docs/HISTORY.md` · `docs/PROGRESS.md` · `docs/EDITOR_PLAN.md §12`)
