...
> **DANAS (poslije BUG-032): javno 4, prijavljeno 0, i sva 4 su tvrdnja ④ na `about`.**
> *(Do 2026-08-24 ih je bilo 8 — druga četiri su bila `lessons`, i pala su s BUG-032.)*
> ~~4 × `lessons`~~
> (BUG-032) i 4 × `about` (čeka Leonovu odluku). Trenutnu brojku uvijek zna
> `tests/phone-baseline.json`, ne ova proza.
