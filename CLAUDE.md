...
- **`npm run preflight`** — svi brzi deploy-gate-ovi u jednom (verify · bump:check · css-drift · **check:tailwind** · typecheck · schema · export-drift · check:docs · unit); pokreni PRIJE svakog main-pusha (i pre-push hook ga automatski vrti na main).
