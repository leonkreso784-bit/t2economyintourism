...
- **🎯 ŠTO SADA RADIMO (jedna rečenica):** dovršavamo **ADMIN CRUD (F4)** kroz draft→objavi + editor cigle — plan `docs/EDITOR_PLAN.md` (U-cigle; **U3 ✅ KOMPLETAN → sljedeća = U4 publish-RPC**; prije U4 = točka odluke o 1. deployu f4→main); „UGC" NIJE trenutni posao (to je H2, tek iza F5/F6).
